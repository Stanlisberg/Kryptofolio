        ...
        <div className="">
          <div className=" flex flex-col justify-center items-center lg:flex-row lg:justify-between">
            <div className="w-full lg:w-[50%]">
              <div className="mx-2 text-justify font-mono text-2xl text-white-500 text-blue-300">
                {" "}
                Our Vision.
              </div>
              <p className=" mx-2 my-6 text-justify font-md p-6 border-2 border-dashed border-blue-300">
          ...
          <div className="flex flex-col-reverse justify-center items-center mt-20 lg:flex-row lg:justify-between">
            ...
            <div className="w-full lg:w-[50%]">
              <div className="mx-2 text-end font-mono text-2xl text-white-500 text-blue-300">
                {" "}
                Our Approach.
              </div>
              <p className="mx-2 my-6 text-justify font-md p-6 border-2 border-dashed border-blue-300">
